...
const myBackground = {
  ...
  cssNamesBackground2:
    ...
    `,.Select-option:focus,.ToolsQuestion div,[role="tablist"],.Topic-bar,.List-item .ZVideoToolbar button` +
    ...
    `,.Topstory-container .TopstoryTabs>a::after,.ZVideo,.KfeCollection-CreateSaltCard`,
  /** 背景色透明的元素名称 */
