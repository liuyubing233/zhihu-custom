...
(function () {
  ...
  const myHidden = {
    ...
    cssForKey: {
      ...
      hiddenZhuanlanTitleImage: '.TitleImage,.css-78p1r9,.ArticleItem .RichContent>div:first-of-type:not(.RichContent-cover)>div:last-of-type{display: none!important;}',
