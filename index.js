...
(function () {
  ...
  function hiddenCSS() {
    return `${pfConfig.hiddenAnswerRightFooter ? '.Question-sideColumn{display: none!important;}' : ''}`
      ...
      + `${pfConfig.hiddenItemActions ? '.Topstory-container .ContentItem-actions>span,.Topstory-container .ContentItem-actions>button,.Topstory-container .ContentItem-actions>div,.TopstoryQuestionAskItem-writeAnswerButton,.TopstoryQuestionAskItem-hint{opacity:0!important;height:0!important;padding:0!important;}' : ''}`
