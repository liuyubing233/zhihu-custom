...
(function () {
  ...
  async function myChanger(ev, type) {
    ...
    const ob = {
      ...
      'questionCreatedAndModi   fiedTime': addQuestionCreatedAndModifiedTime,
    ...
    init: function () {
      const cssVersion = '<style type="text/css" id="pf-css-version">'
        ...
        + (pfConfig.listOutPutNotInterested
          ...
          + `.ContentItem-title{pointer-events:none;}.ContentItem-title>div{pointer-events:auto;}`
          : '')
        + '</style>'
  ...
  // 调用[不感兴趣]接口
  function doFetchUninterestv2(itemId, type) {
