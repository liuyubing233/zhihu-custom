  ...
  const myBackground = {
    ...
    dark: (bg) => {
      ...
      const bgB1 =
        ...
        `,.css-iebf30,.css-1qjzmdv,.AnswerForm-footer,.css-g3xs10,.css-jlyj5p,.css-805ti0,.css-12yl4eo,.css-1ggwojn,.css-xqep55` +
        `,.css-mjg7l1,.css-q2yfd6,.css-1ulkprw,.Card,.ContentItem-actions,.QuestionHeader,.ShelfTopNav-root-eb3BX` +
        ...
        `,.WebPage-root-g7WXc,.KfeCollection-FeedBlockSetting` +
