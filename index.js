...
如果开启了「不再显示已屏蔽用户发布的内容」那么也不会看到对方发布的回答`;
  ...
  var changeHTML = (status) => {
    domById("CTZ_FETCH_STATUS").innerHTML = status ? '<b style="color: #00bfa5;">已开启接口拦截</b>，若页面无法显示数据请尝试' : '<b style="color: #d50000;">已关闭接口拦截</b>，部分功能不可用';
