...
(function () {
  ...
  function initPreviewImg() {
    ...
    if (pfConfig.zoomAnswerImage === 'original') {
      $('.origin_image').each(function () {
        const src = $(this).attr('data-original') || $(this).src
        this.src = src
