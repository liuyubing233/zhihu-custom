...
(() => {
  ...
  var replaceBlockedCommentContent = (item, commentBoxClass, blockedUser, showBlockUserTagType) => {
    ...
    if (!commentContent || commentContent.classList.contains(CLASS_BLOCKED_CONTENT_REPLACEMENT3)) return;
    commentContent.innerHTML = BLOCKED_CONTENT_REPLACEMENT_TEXT3 + createBlockedUserTagHTML(showBlockUserTagType, blockedUser);
    commentContent.classList.add(CLASS_BLOCKED_CONTENT_REPLACEMENT3);
