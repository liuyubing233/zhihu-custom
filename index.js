...
(function () {
  ...
  function initCSSVersion() {
    ...
    const heartVC =
      ...
      + `,.Post-content .RichContent-actions,.RichContent-actions.is-fixed,.Post-NormalMain .Post-Header`
