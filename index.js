...
(function () {
  ...
  function initCSSVersion() {
    const cssVersion = '<style type="text/css" id="pf-css-version">'
      ...
      .ExploreHomePage,.QuestionWaiting,.SearchTabs-inner,.Search-container,.ProfileHeader,.Profile-main,
      .CollectionsDetailPage,.ColumnPageHeader-content,.SettingsMain,.App-main .Creator,.Collections-container,
      .Balance-Layout,.zhuanlan .Post-NormalMain .Post-Header,.zhuanlan .Post-RichTextContainer,
      .zhuanlan .Post-NormalMain>div,.zhuanlan .Post-content .RichContent-actions,.zhuanlan .Post-NormalSub>div{width:${vHeart().v}!important;}`
      ...
      .Post-content .RichContent-actions,.Post-NormalMain .Post-Header, .Post-NormalMain>div,
      .Post-NormalSub>div,.css-1xy3kyp,.css-1voxft1,.WriteIndexLayout-main{width:${vHeart().vContent}!important;}`
  ...
  // hiddenDetailAvatar: false, // 详情回答人头像
  //   hiddenDetailName: false,: false, // 详情回答人简介
  //   hiddenDetailVoters: false, // 详情回答人下赞同数
