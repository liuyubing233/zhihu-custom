  ...
  const myListenListItem = {
    ...
    init: function () {
      ...
      for (let i = this.index, len = elements.length; i < len; i++) {
        ...
        if (pfConfig.highlightOriginal && dataZop && dataZop.authorName === userName && !message) {
