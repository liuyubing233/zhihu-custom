...
(function () {
  ...
  async function myChanger(ev, type) {
    ...
    const ob = {
      ...
      'answerVideoLink': initCSSVersion,
  ...
  function initCSSVersion() {
    ...
    pathnameHasFn({
      'question': listenQuestionSideColumn,
    })
  }
  ...
  // 回答列表中视频显示方式
  function answerVideoLinkCSS() {
    const cssObj = {
      default: '',
      justText: `.List-item .ZVideoLinkCard-playerContainer{display: none;}`
        + `.List-item .ZVideoLinkCard-info::before{content: '视频链接：';color: #06f;}`,
      hidden: '.List-item .RichText-ZVideoLinkCardContainer{display: none;}'
    }
