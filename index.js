...
如果开启了「不再显示已屏蔽用户发布的内容」那么也不会看到对方发布的回答`;
  ...
  var itemVideoUseLink = (nodeFound, prevVideoSrc = "") => {
    setTimeout(() => {
