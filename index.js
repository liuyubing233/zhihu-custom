...
(function () {
  ...
  const myBackground = {
    ...
    transparentBackground: () => {
      return `.zhuanlan .RichContent-actions.is-fixed,.AnnotationTag{background-color: transparent!important;}`
    }
  }
