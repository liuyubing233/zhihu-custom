...
(function () {
  ...
  function zoomVideos() {
    if ($('.VideoContributionAnswer-container').length && pfConfig.answerVideoLink === 'justText') {
      document.querySelectorAll('.VideoContributionAnswer-container').forEach((item) => {
        item.onclick = () => {
  ...
  const versionCSS = {
    ...
    vAnswerVideo: function () {
      ...
      const cssObj = {
        ...
        justText: `.ZVideoLinkCard-playerContainer, .VideoContributionAnswer-video,.css-ujtn9j`
          ...
          + `.ZVideoLinkCard::before,.VideoContributionAnswer-container::before`
        ...
        hidden: '.RichText-ZVideoLinkCardContainer,.VideoContributionAnswer-container{display: none;}'
      }
    ...
    vHidden: function () {
      ...
      return (pfConfig.hiddenLogo
        ...
        + (pfConfig.hidden618HongBao ? '.MCNLinkCard[data-mcn-source="淘宝"],.MCNLinkCard[data-mcn-source="京东"]{display:none;}' : '')
    },
  }
