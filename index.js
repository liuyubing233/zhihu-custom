...
(function () {
  ...
  function changeVersion () {
    const cssVersion = '<style type="text/css" id="pf-css-version">' +
      ...
      + `${pfConfig.suspensionHomeTab ? `.Topstory-container .TopstoryTabs{position:fixed;${vTabPosition()}z-index:100;display:flex;flex-direction:column}.Topstory-container .TopstoryTabs>a{font-size:0 !important;border-radius:50%}.Topstory-container .TopstoryTabs>a::after{font-size:14px!important;display:inline-block;padding:4px 6px;border-radius:50%;border:1px solid #999999;margin-bottom:8px;color:#999999}.Topstory-container .TopstoryTabs>a.TopstoryTabs-link.is-active::after{color:#0066ff !important;border-color:#0066ff !important}[aria-controls='Topstory-recommend']::after{content:'推'}[aria-controls='Topstory-follow']::after{content:'关'}[aria-controls='Topstory-hot']::after{content:'热'}` : ''}`
      + '</style>'
