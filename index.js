  ...
  function resizeFun() {
    ...
    if (myLocalC.bodySize === myLocalC.bodySizePrev) {
      ...
      if (/\/question\//.test(location.pathname)) {
        ...
        pfConfig.answerUnfold && $('.ContentItem-expandButton').each(function () {
          this.click()
        })
      }
    } else {
