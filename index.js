  ...
  var myAnswerPDF = {
    addBtn: (nodeAnswerItem) => {
      ...
      nodeButton.onclick = function() {
        ...
        if (!iframe.contentWindow || !nodeAnswerContent)
          return;
        const doc = iframe.contentWindow.document;
        doc.body.innerHTML = "";
