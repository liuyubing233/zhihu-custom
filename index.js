  ...
  const myBackground = {
    ...
    dark: (bg) => {
      ...
      const backgroundB2 =
        ...
        `,.PubIndex-CategoriesHeader,.AppHeader,body,.UserPageItem--withButton,.QuestionWaiting-typesTopper` +
