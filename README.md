...
**4.X 版本的详细更新内容在 [更新日志](https://github.com/liuyubing233/zhihu-custom/blob/main/CHANGELOG.md) ，简介存在更新不及时的情况。**
...
屏蔽官方账号的回答、屏蔽匿名用户的回答、屏蔽带有标签的回答如 `选自盐选专栏`。

设置 `详情低赞回答屏蔽` 后，点赞量低于输入框中的回答会被自动过滤
...
<span style="color: red">更多详细功能请在使用中查看</span>
